...
# Generated on: Mon Jan 19 23:39:03 -03 2026 (Tue Jan 20 02:39:03 UTC 2026)
...
set logfile fv/cpu/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_library -liberty -both \
    /home/aluno/Imagens/PROJETOFINAL/Base_de_Dados/PROJETO/../LIB/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k RTL/adder.v RTL/alu.v RTL/control.v RTL/cpu.v RTL/data_memory.v RTL/datapath.v RTL/fowarding_control.v RTL/fp2int.v RTL/FPU.v RTL/instruction_memory.v RTL/int2fp.v RTL/maindec.v RTL/multiply.v RTL/mux.v RTL/pc_reg.v RTL/register_file_f.v RTL/register_file.v RTL/sign_extender.v
elaborate_design -golden -root {cpu} -rootonly -rootonly  
...
set_system_mode lec
write_compared_points noneq.compared_points.cpu.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.cpu.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.cpu.rtl.fv_map.rpt
